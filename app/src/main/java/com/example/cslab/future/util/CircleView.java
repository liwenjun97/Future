...
//            canvas.drawText(titleEn, 0, titleEn.length(), center, center + radiusOfCircle + offset1, mTextPaint);
            canvas.drawText(titleCn, 0, titleCn.length(), center, center+offset2+radiusOfCircle, mTextPaint);
        } else {
//            canvas.drawText(titleEn, 0, titleEn.length(), center, center + radiusOfCircle + offset4, mTextPaint);
            canvas.drawText(titleCn, 0, titleCn.length(), center, center+offset5+radiusOfCircle, mTextPaint);
        }
        super.onDraw(canvas);
    }
