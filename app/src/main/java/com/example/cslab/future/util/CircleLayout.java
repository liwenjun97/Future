...
//        addAroundSmallCircle();
    ...
    private void addAroundCircle() {
        ...
        for (int i = 0; i < aroundCircleCount; i++) {
            ...
            attrEntity.aroundCircleTitleCn = aroundCircleTitleCn[i];
//            attrEntity.aroundCircleTitleEn = getResources().getString(aroundCircleTitleEn[i]);
            ...
            itemCView.setPadding(ViewUtil.dp2px(context, 18), ViewUtil.dp2px(context, 18), ViewUtil.dp2px(context, 18), ViewUtil.dp2px(context, 48));
    ...
    private void addAroundSmallCircle() {
        ...
        for (int i = 0; i < aroundCircleCount; i++) {
            ...
            wCView.setText(String.valueOf(aroundSmallCircleindex[i]));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (progressNum < aroundCircleCount) {
            ...
            if (!TextUtils.isEmpty(centerCircleText)) {
                canvas.drawText(centerTitle, 0,centerTitle.length(), center, center+offset, centerCircleTopTextPaint);
            }
...
//        }
    ...
    public void setView(
            ...
            int[] aroundSmallCircleindex) {

        if (aroundCircleTitleCn.length != aroundCircleCount
            || circleIcon.length != aroundCircleCount
            || circleCompleteStatusList.length != aroundCircleCount
            || aroundSmallCircleindex.length!=aroundCircleCount) {
            return;
        }
        ...
        this.aroundSmallCircleindex=aroundSmallCircleindex;
    }
