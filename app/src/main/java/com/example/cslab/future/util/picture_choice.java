...
import com.example.cslab.future.activity.Person_Data_Activity;
...
public class picture_choice extends AppCompatActivity implements View.OnClickListener {
    ...
    private String urlForChangeDream;
    private String urlForGetDream;
...
     */
    ...
    private void setImageToHeadView(Intent intent) {
        ...
        if (extras != null) {
            ...
            //保存到本地
            try {
                saveBitmap(photo, User.uToken+".jpg");
            } catch (IOException e) {
                e.printStackTrace();
            }
            //上传至服务器
    ...
    {
        File file = new File(getApplicationContext().getFilesDir().getAbsolutePath()+"/Img_dream/"+bitName);
        if(file.exists()){
            file.delete();
        }
    ...
    public void changeDreamImg(){
        ...
        Thread t = new Thread(){
            ...
            public void run() {
                ...
                saveForGetDream = getApplicationContext().getFilesDir().getAbsolutePath()+"/Img_dream/"+fileName;
                ...
                msg.setData(data);
                handlerForChangeDreamImg.sendMessage(msg);
    ...
    private Handler handlerForChangeDreamImg =new Handler(){
        @Override
        ...
        public void handleMessage(Message msg){
            ...
            try {
                ...
                if (json.optString("success")!=""){
                    ...
                    Intent it=new Intent(picture_choice.this, Person_Data_Activity.class);
                    startActivity(it);
                    finish();
                }else {
                    new SweetAlertDialog(picture_choice.this, SweetAlertDialog.ERROR_TYPE)
                            .setTitleText("ERROR")
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_CANCELED) {
            Toast.makeText(picture_choice.this, "取消", Toast.LENGTH_SHORT).show();
            return;
        }
        switch (requestCode) {
